    ...
    <div class="navbar-inner">
        <div class="container">
            <ul class="nav nav-pills">
                ...
                <li><a href="../include/vhod.php">Вход</a></li>
                <li><a href="../include/reg.php">Регистрация</a></li>
                <li><a href="vk/vk.php"><img width="25" height="25" title="Войти через соц сеть Вконтакте" src="/images/vk.jpg"></a></li>
            </ul>
        </div>
    </div>
</div>
